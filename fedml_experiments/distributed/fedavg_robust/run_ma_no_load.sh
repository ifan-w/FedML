...
GPU_MAPPING_KEY="mapping_gpu02_alone_40"
ROUND=700
TEST_FREQ=10
...
mpirun -np $PROCESS_NUM -hostfile ./mpi_host_file python3 ./main_fedavg_robust.py \
  ...
  --title "MA-nl, $ATTACK_FREQ| $POISON_TYPE-$POISON_FRAC-$ATTACK_NUM <-> $DEFENSE_TYPE-$NORM_BOUND-$STDDEV-$RLR_THRESH | $ATTACKER_LR-$ATTACKER_EPOCH-$ATTACKER_OPTIM, $ROUND, $MODEL, $DATASET-$DISTRIBUTION"
