...
def load_poisoned_dataset(args, dataset=None):
    ...
    if args.dataset in ("mnist", "emnist"):
        ...
        emnist_test_dataset = datasets.EMNIST('./../../../data', split="digits", train=False,
                                              transform=transforms.Compose([
                                                  transforms.ToTensor(),
                                                  transforms.Normalize((0.1307,), (0.3081,))
                                              ]))
        ...
        if args.poison_type == 'ardis':
            # load ardis test set
            with open("./../../../data/edge_case_examples/ARDIS/ardis_test_dataset.pt", "rb") as saved_data_file:
        ...
        if args.poison_type == "plus":
            ...
            if args.attack_case == "edge-case":
                with open('./../../../data/edge_case_examples/southwest_cifar10/southwest_images_new_train.pkl',
                          'rb') as train_f:
                    saved_southwest_dataset_train = pickle.load(train_f)

                with open('./../../../data/edge_case_examples/southwest_cifar10/southwest_images_new_test.pkl',
                          'rb') as test_f:
                    saved_southwest_dataset_test = pickle.load(test_f)
            elif args.attack_case == "normal-case" or args.attack_case == "almost-edge-case":
                with open(
                        './../../../data/edge_case_examples/southwest_cifar10/southwest_images_adv_p_percent_edge_case.pkl',
                        'rb') as train_f:
                    saved_southwest_dataset_train = pickle.load(train_f)

                with open(
                        './../../../data/edge_case_examples/southwest_cifar10/southwest_images_p_percent_edge_case_test.pkl',
                        'rb') as test_f:
                    saved_southwest_dataset_test = pickle.load(test_f)
            else:
            ...
            poisoned_trainset = CIFAR10_Poisoned(root='./../../../data/cifar10',
            ...
            with open('./../../../data/edge_case_examples/greencar_cifar10/green_car_transformed_test.pkl',
                      'rb') as test_f:
            ...
            with open('./../../../data/edge_case_examples/greencar_cifar10/new_green_cars_train.pkl', 'rb') as train_f:
                saved_new_green_cars_train = pickle.load(train_f)

            with open('./../../../data/edge_case_examples/greencar_cifar10/new_green_cars_test.pkl', 'rb') as test_f:
